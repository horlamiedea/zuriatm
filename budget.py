...
def create_spend_chart(categories):
    return "Olamide Budget's"



d = float(input("enter deposite  "))
w= float(input("enter amount to withdraw  "))
t = float(input("enter amount to transfer  "))

food = Category("Food")
food.deposit(d, "initial deposit")
food.withdraw(w, "groceries")
food.withdraw(w, "restaurant and more food for dessert")
print(food.get_balance())
clothing = Category("Clothing")
food.transfer(w, clothing)
clothing.withdraw(w)
clothing.withdraw(w)
auto = Category("Auto")
auto.deposit(5000, "initial deposit")
auto.withdraw(10)
